...
def seed_realistic_large_dataset():
    ...
    #     gender = random.choices(["Male","Female"],weights=[0.65,0.35],k=1)[0]
    ...
    #     units = str(random.choices([350,450],weights=[0.75,0.25],k=1)[0])
    ...
    #     units = str(random.choices([150,250,350,450,700,900,1050,1350],weights=[5,8,35,20,15,8,6,1],k=1)[0])
